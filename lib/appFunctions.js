  ...
  switch (choice) {
    case 'employee':
      ...
      inquirer.prompt(prompts.prompts.addEmployee).then(answer => {
        ...
        console.log(
          `--- Added an ${answer.firstName} ${answer.lastName} to the database! ---`
        );
      });
      break;
    case 'department':
...
function remove(choice) {
  switch (choice) {
    case 'employee':
      ...
      break;
    case 'department':
      // TODO: delete employees with departmentId that I am deleting
      ...
      //   });
      //   console.log(
      //     `--- Removed ${answer.removeDepartment} from the database ---`
      //   );
      // });
      break;
    case 'role':
...
//     let employeeIdIndex = prompts.employeeChoices.indexOf(answer.updateEmployee);
//     let employeeId = employeeIds[employeeIdIndex];

//     let newInfo = prompts.roleChoices.indexOf(answer.roleUpdate) + 1;
...
//         let employeeIdIndex = prompts.employeeChoices.indexOf(answer.updateEmployee);
//         let employeeId = employeeIds[employeeIdIndex];
//         let newRole = prompts.roleChoices.indexOf(answer.roleUpdate) + 1;
...
//         let employeeIdIndex = prompts.employeeChoices.indexOf(answer.updateEmployee);
//         let employeeId = employeeIds[employeeIdIndex];
//         let newManager = prompts.roleChoices.indexOf(answer.roleUpdate) + 1;
