...
function view(choice) {
  switch (choice) {
    ...
    case 'employeesDepartment':
      inquirer.prompt(prompts.prompts.viewEmployeesDepartment).then(answer => {
    ...
    case 'employeesManager':
      inquirer.prompt(prompts.prompts.viewEmployeesManager).then(answer => {
    ...
    case 'managers':
      ...
      break;
    case 'budget':
      inquirer.prompt(prompts.prompts.viewBudget).then(answer => {
